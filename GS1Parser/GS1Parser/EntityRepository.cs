    ...
    public static class EntityRepository
    {
        private static readonly SortedDictionary<string, Entity> Entities = new SortedDictionary<string, Entity>(
            new List<Entity>
            {
                ...
                new Entity("11", "ProducerDate_YYMMDD", 2, DataType.Date, 6, false),
                new Entity("12", "DueDate_YYMMDD", 2, DataType.Date, 6, false),
                new Entity("13", "PackingDate_YYMMDD", 2, DataType.Date, 6, false),
                new Entity("15", "MinimumDurabilityDate_YYMMDD", 2, DataType.Date, 6, false),
                new Entity("17", "ExpiryDate_YYMMDD", 2, DataType.Date, 6, false),
